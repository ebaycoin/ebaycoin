Ebaycoin (EBC) - a 'faster' version of Litecoin which also uses scrypt
as a proof of work scheme and is intended for microtransactions.
 ...
 - curreSmallChangently peers are looked up over IRC only
...
So actually, this 'new' coin exists for the following reasons:
 - EBC proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'ebaycoin' for the
